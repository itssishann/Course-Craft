...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-2 lg:px-12">
        <div className="flex items-center gap-x-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-md font-medium text-richblack-300">{user?.email}</p>
          </div>
        </div>
